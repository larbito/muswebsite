...
(function () {
  ...
  const FEATURES = [
    ...
    { icon: 'series', title: 'ترجمة بعدة لغات', text: 'أغلب الأفلام والمسلسلات متوفرة بترجمة احترافية بعدة لغات — عربية وإنجليزية وفرنسية وغيرها.' },
    { icon: 'bolt', title: 'مشاهدة بدون إعلانات', text: 'استمتع بأفلامك ومبارياتك دون أي إعلانات مزعجة تقطع المشاهدة.' },
  ];

  const PLANS = [
    { id: 'm1', name: 'شهر واحد', price: 99, note: '', features: ['+60,000 قناة مباشرة', '+120,000 فيلم ومسلسل', 'ترجمة بعدة لغات', 'جودة 4K حقيقية', 'دعم فني 24/7'] },
    { id: 'm3', name: '3 أشهر', price: 179, note: 'وفّر 40%', features: ['كل مميزات باقة الشهر', 'ترجمة بعدة لغات', 'أولوية في الدعم الفني', 'تفعيل فوري', 'جهازان في نفس الوقت'] },
    { id: 'm6', name: '6 أشهر', price: 279, note: 'وفّر 53%', features: ['كل مميزات باقة 3 أشهر', 'ترجمة بعدة لغات', 'سيرفر احتياطي مجاني', 'محتوى رياضي كامل', 'جهازان في نفس الوقت'] },
    { id: 'm12', name: '12 شهراً', price: 349, note: 'وفّر 71% — الأفضل قيمة', featured: true, features: ['كل المميزات بدون استثناء', 'ترجمة بعدة لغات', 'تفعيل التطبيق مجاناً 🎁', 'شهر إضافي هدية', 'سيرفر احتياطي مجاني', 'أولوية قصوى في الدعم'] },
  ];
