...
(function () {
  ...
  const PLANS = [
    ...
    { id: 'm12', name: '12 شهراً', price: 349, note: 'وفّر 71% — الأفضل قيمة', featured: true, features: ['كل المميزات بدون استثناء', 'تفعيل التطبيق مجاناً 🎁', 'شهر إضافي هدية', 'سيرفر احتياطي مجاني', 'أولوية قصوى في الدعم'] },
  ];
